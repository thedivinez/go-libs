...
type RockPaperScissorsClient interface {
	...
	UpdateSoccerSettings(ctx context.Context, in *RockPaperScissorsAdmin, opts ...grpc.CallOption) (*UpdateSettingsResponse, error)
}
...
func (c *rockPaperScissorsClient) UpdateSoccerSettings(ctx context.Context, in *RockPaperScissorsAdmin, opts ...grpc.CallOption) (*UpdateSettingsResponse, error) {
	out := new(UpdateSettingsResponse)
	err := c.cc.Invoke(ctx, "/RockPaperScissors/UpdateSoccerSettings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RockPaperScissorsServer interface {
	...
	UpdateSoccerSettings(context.Context, *RockPaperScissorsAdmin) (*UpdateSettingsResponse, error)
}
...
func (UnimplementedRockPaperScissorsServer) UpdateSoccerSettings(context.Context, *RockPaperScissorsAdmin) (*UpdateSettingsResponse, error) {
...
func _RockPaperScissors_UpdateSoccerSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RockPaperScissorsAdmin)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RockPaperScissorsServer).UpdateSoccerSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/RockPaperScissors/UpdateSoccerSettings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RockPaperScissorsServer).UpdateSoccerSettings(ctx, req.(*RockPaperScissorsAdmin))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RockPaperScissors_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RockPaperScissors_UpdateSoccerSettings_Handler,
		},
	},
